/**
 * **사건 셈** — 판(frame)의 흐름에서 「쥐었다 / 놓았다 / 끌었다」를 낸다.
 *
 * ⚠ **손은 「고르기」에 안 쓴다.** 실측된 제약: 손짓으로 고르게 하면 처리량이 절반이고 틀림이
 * 네 배다. 그래서 여기가 내는 것도 **연속 조작**(끌기·당기기)뿐이고, 「눌러서 고르기」는
 * 마우스·자판 몫으로 남긴다.
 *
 ...
 * 빠르게 움직일 땐 약하게 눌러 따라가게. 한 계수로 고정하면 「조용하지만 굼뜨다」가 된다.
 */
