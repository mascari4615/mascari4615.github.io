 ...
 *
 * 앞선 확인은 한 프로세스가 얼마나 바빴나까지였다. 그건 작업 관리자가 보여 주는 값이 아니다 . 
 ...
 * 안 나타난다. 그때 실패라고 말하면 거짓말이다. 코드가 틀린 게 아니라 **잴 수가 없는 것**이다.
...
for (let column = 0; column < COLUMNS; column++) {
	...
	// 쉬고, 그 쉬는 시간까지 창 안에 넣어야 이 조각 동안 얼마나 바빴나가 된다.
