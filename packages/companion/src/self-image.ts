 ...
 *
 * 우리 얘는 **조수님은 알아도 자기를 몰랐다**(16회차에서 만든 아는 것은 조수님 얘기다).
 ...
 * 그대로**다.
 *
 * 재료도 아무 말이나 쓰지 않는다. 얘가 내가라고 말한 문장을 전부 긁으면 놀이 잡담이
 * 쏟아진다(실측: 자기 언급 11개 중 7개가 내가 이겼다류였다). **조수님이 얘에 대해 물은
 ...
 *
 * 처음엔 여섯 자 넘으면 자기 얘기로 걸렀는데, 라이브에서 **한 개도 안 잡혔다.**
 ...
 *
 * 호응, 회피는 자기를 말한 게 아니다. 그걸 자기상으로 쌓으면 노트가 응으로 가득 찬다.
 */
 ...
 * 자기상. 껐다 켜도 이어진다.
 *
 * 오래된 것부터 버린다. 예전에 이렇게 말했다가 스무 줄이면 그건 인격이 아니라 서류다.
 */
