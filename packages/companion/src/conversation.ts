 ...
 * 90%다. 그래서
 * - 아는 것이 342턴을 겪고도 텅 비어 있었다. 졸일 재료 마흔 개가 전부
 *   화면을 봤다. 창은 ...였으니 사람에 대해 뽑을 게 없었다.
 * - 하루의 매듭(15회차)이 마지막으로 나눈 얘기로 화면 로그를 집었다. 인사가 부실했던 게
 ...
 * 취급돼 회상에도, 마지막으로 나눈 얘기에도 실렸다(111회차 실측 12건).
...
/**
 * 얘가 혼자 본 것만 남긴다. 지금 뭐 하고 있나를 물을 때 쓴다.
 *
