 ...
 * 있었다는 걸 안다.**
 *
 * 우리 얘는 세상에 **조수님 한 사람만** 있었다. 오늘 김 대리랑 회의했어라고 해도 다음에
 ...
 * 한 번은 스쳐 지나간 말일 수 있고, 잘못 잡은 이름을 곁의 사람이라고 우기는 게 못 잡는
 * 것보다 나쁘다.
 */
 ...
 * 부름 뒤에 올 수 있는 글자들.
 *
 * 조사를 빠뜨리면 조용히 안 잡힌다. 처음엔 민수 씨한테 팀장님께가 통째로 빠졌다.
 * 그렇다고 아무 글자나 허용하면 씨앗이 사람이 된다. 그래서 **조사 첫 글자만** 열어 둔다.
 */
 ...
 *
 * 뽑히는 건 **부르는 말까지 포함한 통짜**다. 김 대리를 김으로 줄이면 다음에 김
 * 과장이 나왔을 때 같은 사람으로 잘못 묶인다.
 */
 ...
 * 두뇌에 넘길 한 줄.
 *
 * **누구인지는 안 적는다.** 김 대리 = 직장 동료처럼 단정하면 틀렸을 때 그대로 굳는다.
