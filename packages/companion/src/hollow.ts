 ...
 * 대꾸가 이어지면 사람은 지루해하고, 그 순간 말이 통하는 상대가 아니게 된다.
 *
 ...
 *
 * 회피 감시(14회차)와 다른 자리다. 그건 다음 번에 모른다고만 하지 마라고 **잔소리**하고,
 * 이건 그 자리에서 **다시 시킨다.** 이미 뱉은 뒤의 지적은 늦다.
 */

/** 알맹이가 없는 대꾸. 호응, 머뭇거림뿐. */
const emptyShape = /^[…\s.]*(응|어|음|아|오|네|그래|그렇구나|그러게|그치|맞아|알겠|오케이|ㅇㅇ|글쎄|몰라|모르겠|아니|아냐|아니야|아니다)[…\s.!?~]*$/;
