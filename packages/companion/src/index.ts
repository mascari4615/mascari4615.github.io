...
export { enableSpeech, worthSpeaking } from './voice/speakable';
...
export * from './touch';
export { searchWeb, readIn, extractResults, textOnly, resolveUrl } from './hands/web';
export { demandBoot, onDemand, type DemandBootOptions } from './voice/on-demand';
export { sibling, thisRepo, repoCopies } from './workspace';
export { lineStore, select, type StockOptions } from './stock';
export * from './people';
export * from './quiet';
export * from './resume';
...
export { meaningMemory, measureWithSmallModel, similarity, type MeaningMeasure, type MeaningMemoryOptions } from './memory/meaning';
export * from './rarity';
export * from './length';
