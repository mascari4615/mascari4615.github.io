...
export { reflexFor, reflexTone as 반사결, reflexKind as 반사갈래, reflexKinds as 반사종류들, type ReflexOptions } from './reflex';
...
export { enableSpeech as 말할수있게, worthSpeaking as 소리낼만한가 } from './voice/speakable';
