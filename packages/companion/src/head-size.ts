 ...
 * 무거운 자리에서만 큰 머리를 쓴다.
 *
 * 84회차에 왜 늘 일고여덟 자로 답하나를 실험으로 갈랐다. 같은 말을 넣고 조건만 바꿨다:
 *
 * ```
 * 지금 그대로   2자 | 또...
 ...
 *
 * **이유를 같이 낸다.** 왜 이 turn 만 느렸지를 나중에 알 수 없으면, 큰 머리를 쓰는 게
 * 고장으로 보인다(오늘까지 왜가 없어서 실험을 다시 돌린 자리가 넷이다).
 */
