 ...
 *
 * 지울 낱말은 **얘가 한 말**에서 고른다. 조수님이 아니야라고만 했을 때 조수님 말에서
 * 뽑으면 아니를 지우려 들기 때문이다.
 */
 ...
 * 두뇌에 넘길 한 줄.
 *
 * **우기지 말라고 한다.** 잘못 안 걸 지적받았을 때 변명하거나 그런 뜻이 아니었다고 하는
