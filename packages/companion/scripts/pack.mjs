 ...
 * 부르는데 그건 이 목록에 없었다(2026-08-19 실측). 사람이 무엇이 무엇을 부르나를
...
// 꾸러미 표는 배포판 것으로 다시 적는다. 선택물이 필수로 남아 있으면 설치가 1GB 를 끌어온다.
...
/* **받은 사람이 처음 보는 글.** 저장소 README 는 만드는 사람 것이라 여기선 쓸모가 없다 . 
   어디에 뭐가 있나가 아니라 무엇을 누르면 되나가 필요하다. */
writeFileSync(
  join(out, '읽어주세요.txt'),
  [
    '동반자. 곁에 있는 존재',
    ...
    '   게임의 필수 구성 요소와 같은 자리다. 이 꾸러미에는 안 들어 있다.',
    '',
