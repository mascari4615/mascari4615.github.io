// 누를게라고 **말만** 하는 것 (TASK-KAR-241).
//
// 121회차에 누르는 손을 붙였다. 122회차 라이브에서 화면에서 아무거나 하나 눌러봐라고
// 했더니 이렇게 답했다:
//
...
//
// 40회차 관문은 했다는 거짓말을 잡는다. 이건 다르다. **할게라고 하고 안 하는 것**이다.
// 41회차에 약속을 막으면 안 된다고 정했으니 넓게 잡으면 안 된다. 그래서 **지금 이 turn 에
