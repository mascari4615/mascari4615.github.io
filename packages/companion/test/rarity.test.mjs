...
test('드물게 켜진 재료가 늘 있던 재료를 이긴다 — 이게 이 자리를 만든 이유다', () => {
  ...
  const 드묾붙여 = pickIngredients(applyRarity(목록, (n) => 셈표[n]), { maxChars: 25, maxLines: 1 });
