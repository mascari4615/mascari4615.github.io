...
/* ── 높은 쪽 고르기 ── */
{
  ...
  say(r.hideAgain, 'higher: 끝나지도 않았는데 다시가 떠 있다');
   ...
   * 위 검사를 이겼을 때만으로 묶어 두었더니, 첫 판을 지는 날에는 통째로 건너뛰었다 . 
