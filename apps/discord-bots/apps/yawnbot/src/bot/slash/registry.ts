...
import type { AutocompleteInteraction, ChatInputCommandInteraction, InteractionReplyOptions } from 'discord.js';
...
/** 커맨드 레지스트리 엔트리. run = sub/group 분기·가드 포함 그 커맨드의 전체 dispatch. */
