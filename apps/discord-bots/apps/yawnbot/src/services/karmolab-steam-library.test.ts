 ...
 * 게임이 없다로 말하면 사람은 자기 계정을 의심한다. 열쇠가 없을 때도 마찬가지 . 
 * 고장이 아니라 아직 안 켰다여야 한다.
 */
...
describe('숫자 옮기기', () => {
  ...
  it('안 한 게임은 시간 칸을 비운다. 0 으로 채우면 제일 안 한 게임이 거짓이 된다', () => {
...
describe('서재 길어 오기', () => {
  it('열쇠가 없으면 고장이 아니라 아직 안 켰다', async () => {
  ...
  it('비공개 프로필은 빈 성공으로 온다. 게임이 없다로 말하지 않는다', async () => {
