 ...
 * 전혀 다른 파일이라고 답한다. 그게 `filehash` 의 일이고, 이건 그 반대쪽 일이다.
 *
 ...
 *   여기서 같다는 *눈으로 봐서 같은 장면*이지 *같은 피사체*가 아니다.
 */
 ...
 *
 * 격자 길이가 안 맞으면 **던진다.** 조용히 0 으로 채우면 모든 사진이 비슷하다는 답이
 ...
 * 그래서 같다가 아니라 거의 같다로 말한다. 우리가 못 재 본 것을 잰 척하지 않는다.
 */
