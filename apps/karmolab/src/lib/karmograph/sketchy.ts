/**
 * lib/karmograph/sketchy.ts. **손그림 질감** (TASK-KL-238 / 18 excalidraw)
 *
 * excalidraw 가 사랑받는 이유는 기능이 아니라 **말투**다. 자로 잰 상자는 결정된 것처럼 보여서
 * 사람이 고치자는 말을 못 꺼낸다. 삐뚤빼뚤한 상자는 아직 얘기 중처럼 보인다 . 
...
/** 삐뚤빼뚤의 크기(px). 이보다 크면 손그림이 아니라 망가진 그림이 된다. */
