/**
 * lib/karmograph/canvas-release.ts. **손을 떼면 무슨 뜻인가** (TASK-KL-202 방향① 해체: 입력 조각 2).
 *
...
/** 마우스는 4px 만 흔들려도 사람이 끌었다고 느끼지만, **손가락은 그 정도로 늘 흔들린다**. */
 ...
 * 카드 위에서 손을 뗐는데 그 밑을 지나는 선이 골라지면 엉뚱한 게 열린다가 된다.
 */
...
/** 카드를 카드 위에 떨어뜨린 것인가. 자기 자신 위, 그리고 누른 것뿐이면 아니다. */
