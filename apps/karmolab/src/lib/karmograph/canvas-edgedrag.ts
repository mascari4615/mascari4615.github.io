/**
 * lib/karmograph/canvas-edgedrag.ts. **선을 손으로 휘고 이름표를 옮기는 셈법** (TASK-KL-202 방향① 입력 조각 3).
 *
...
/** 이만큼 아래면 곧은 선으로 되돌린다(사람 손은 0 을 못 맞춘다). */
 ...
 * 캔버스 본체에서 if 세 겹으로 살던 판단인데, 빈 곳에 놓으면 새 카드가 붙으면서 규칙이
