 ...
 * 것은 자랑용에 그치고, 표 하나가 놀이 여럿을 켜는 일이 안 일어난다.
 *
 * 그래서 고를 수 있는 표를 여기 한 벌만 둔다. 놀이마다 다시 짜면 그날부터 갈라진다
 * (실제로 높은 쪽 고르기와 스무고개가 이미 같은 코드를 두 벌 갖고 있었다).
 *
 ...
 * 안 빼면 포켓몬이 붙박이로 한 번, `,  karmolab` 사본으로 또 한 번 선다.
 */
