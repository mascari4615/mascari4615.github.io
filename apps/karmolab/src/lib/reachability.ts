 ...
 *
 * downdetector 의 알맹이 절반은 **남들의 제보**(수백만 명이 나도 안 돼요를 누른 기록)라
 ...
 *   200 인지 500 인지 못 본다. 그래서 이 도구가 말하는 된다는 *서버가 응답한다*는 뜻이지
...
/** 이보다 오래 걸리면 된다가 아니라 느리다로 말한다. 사람은 그 차이를 겪고 있다. */
 ...
 * 못 만들면 null. 형식이 틀렸다는 재기 전에 말해야 한다(재고 나서 안 된다고 하면 거짓말이다).
 */
