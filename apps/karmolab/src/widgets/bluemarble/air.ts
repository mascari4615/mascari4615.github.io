 ...
 *
 * `radio.ts` 가 「거기 누가 살고 있나」라면 여기는 **「거기 지금 누가 지나가고 있나」**다.
 ...
 * 여기서는 「어디를 물을지」와 「사람에게 어떻게 말할지」만 정한다.
 *
 * ★ 이 겹의 유일한 거짓말 위험: **온 하늘이 아니다.** 이 원천들은 자원봉사 수신기 망이라
 * 바다 한가운데·수신기 없는 나라는 그냥 안 보인다. 「비행기가 없다」와 「우리가 못 본다」는
 * 다르므로 화면 문구도 그렇게 적는다.
 */
...
/** 뒷단이 펴서 주는 모양 그대로. (`karmolab-air-api.ts` 의 `Plane` 과 한 벌이다) */
...
/** 한 대를 한 줄로. 모르는 값은 **안 적는다** — 「0노트로 난다」는 거짓말이다. */
 ...
 * 정말로 0대일 수 있고 그건 고장이 아니다. 둘을 뭉치면 화면이 「못 받았다」와 「없다」를
 * 같은 말로 하게 된다.
 */
