...
(function (): void {
    ...
    Mdd.injectCSS('favorites', `
        ...
        .fav-view-toggle-btn.active { background:var(--accent-subtle); border-color:var(--accent); color:var(--accent-ink); }
        ...
        .fav-add-tile:hover { opacity:1; border-color:var(--accent); color:var(--accent-ink); background:var(--accent-subtle); }
        ...
        .fav-add-kind .fav-kind-btn.active { background:var(--accent-subtle); border-color:var(--accent); color:var(--accent-ink); }
