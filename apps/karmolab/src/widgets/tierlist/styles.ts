(function () {
    ...
    const injectStyles: { (): void; _done?: boolean } = function () {
        ...
        .tl-ribbon-embed {
            ...
            color:#fff; font-size:var(--font-size-4xs); font-weight:800; letter-spacing:.04em;
        ...
        .tl-badge.tl-badge-local { border-color: rgba(100,116,139,.5); color: var(--text-secondary); font-size:var(--font-size-3xs); }
        ...
        .tl-toc-hint { font-size:var(--font-size-3xs); font-weight:700; color:var(--text-tertiary); margin-right:4px; width:100%; margin-bottom:2px; }
        ...
        .tl-toc-chip {
            ...
            font-size:var(--font-size-2xs); font-weight:800; cursor:pointer; user-select:none; flex-shrink:0;
        ...
        .tl-toc-pool { background:var(--bg-tertiary) !important; color:var(--text-primary) !important; border-color:var(--border) !important; font-weight:700 !important; font-size:var(--font-size-2xs) !important; }
        ...
        .tl-label { width:72px; min-width:72px; display:flex; align-items:center; justify-content:center; font-weight:800; font-size:var(--font-size-title); user-select:none; }
        ...
        .tl-item-badge { position:absolute; top:2px; left:2px; z-index:3; font-size:var(--font-size-4xs); font-weight:800; line-height:1.1; padding:2px 4px; border-radius:var(--radius-sm); pointer-events:none; letter-spacing:-0.02em; box-shadow:0 1px 2px rgba(0,0,0,.35); }
        ...
        .tl-ctx-item { display:block; width:100%; background:none; border:none; color:var(--text-primary); font-size:var(--font-size-2xs); padding:8px 14px; text-align:left; cursor:pointer; }
        ...
        .tl-dialog h3 { margin:0 0 12px; font-size:var(--font-size-sm); }
        .tl-dialog-wide { max-width:440px; }
        .tl-tier-hint { font-size:var(--font-size-2xs); color:var(--text-tertiary); margin:0 0 12px; line-height:1.45; }
        ...
        .tl-ul-row .tl-ul-name { flex:1; min-width:120px; margin-bottom:0 !important; padding:6px 8px; font-size:var(--font-size-xs); }
        ...
        .tl-ul-usage { font-size:var(--font-size-3xs); color:var(--text-tertiary); white-space:nowrap; min-width:2.5em; text-align:right; }
        .tl-ul-row .tl-ul-del { padding:4px 10px; min-width:auto; font-size:var(--font-size-2xs); }
        .tl-ul-assign-list { max-height:min(45vh, 320px); overflow-y:auto; margin-bottom:12px; }
        .tl-ul-assign-row { display:flex; align-items:center; gap:8px; padding:6px 4px; border-radius:var(--radius-sm); cursor:pointer; font-size:var(--font-size-2xs); color:var(--text-primary); }
        .tl-ul-assign-row:hover { background:var(--bg-hover); }
        .tl-ul-assign-row input { flex-shrink:0; }
        .tl-ul-assign-swatch { width:18px; height:18px; border-radius:var(--radius-sm); flex-shrink:0; border:1px solid rgba(0,0,0,.2); }
        .tl-ul-assign-name { flex:1; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
        .tl-dialog label { display:block; font-size:var(--font-size-2xs); font-weight:700; color:var(--text-secondary); margin-bottom:4px; }
        .tl-dialog input[type="text"], .tl-dialog textarea { width:100%; background:var(--bg-tertiary); border:1px solid var(--border); color:var(--text-primary); border-radius:var(--radius-sm); padding:8px 10px; font-size:var(--font-size-xs); margin-bottom:12px; box-sizing:border-box; }
        ...
        .tl-list-section-title { margin:0 0 6px; font-size:var(--font-size-xs); font-weight:700; color:var(--text-primary); }
        .tl-list-subsection-title { margin:12px 0 8px; font-size:var(--font-size-2xs); font-weight:700; color:var(--text-secondary); }
        ...
        .tl-pill {
            ...
            letter-spacing:.03em; padding:3px 8px; border-radius:var(--radius-pill);
            line-height:1.2;
        }
        ...
        .tl-bar-track { flex:1; height:24px; background:var(--bg-tertiary); border-radius:var(--radius-sm); overflow:hidden; position:relative; }
        .tl-bar-fill { height:100%; border-radius:var(--radius-sm); transition:width .4s ease; display:flex; align-items:center; padding-left:8px; }
        ...
        @media (max-width:600px) {
            .tl-label { width:48px; min-width:48px; font-size:var(--font-size-sm); }
