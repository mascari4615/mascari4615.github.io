        ...
        build: function (container: HTMLElement): void {
          ...
          container.innerHTML = `
                    <div style="position:relative; width:100%; height:450px; background:#1a1a2e; overflow:hidden; border-radius:var(--radius-lg); cursor:crosshair;" id="shyArea">
                        <a href="#" id="shyTarget" style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); color:#ff4757; font-size:var(--font-size-display-sm); font-weight:900; text-decoration:none; text-shadow:0 0 10px rgba(255,71,87,0.5); white-space:nowrap; padding:20px; transition: opacity 0.1s; user-select:none;">
                    ...
                    <div id="shyModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.9); z-index:9999; justify-content:center; align-items:center;">
                        <div style="position:relative; width:80%; max-width:800px; aspect-ratio:16/9; background:#000; border-radius:var(--radius-xl); overflow:hidden; box-shadow:0 0 40px rgba(255,0,0,0.3);">
                            <button id="closeShyModal" style="position:absolute; top:10px; right:15px; color:#fff; font-size:var(--font-size-display-sm); background:none; border:none; cursor:pointer; z-index:10; font-weight:bold;">✕</button>
