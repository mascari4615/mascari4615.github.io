 ...
 * 「글자 덩어리」를 **구조로** 바꿔 준다는 것이다 — 사람이 JSON 을 여는 이유의 태반이
 * 「여기 뭐가 들어 있나」이지 「글자를 읽고 싶다」가 아니다.
 *
...
/** 값 한 줄 — 긴 글은 자른다. 잘랐다는 표시를 남겨야 「원래 이만큼인가」로 안 읽힌다. */
 ...
 * 넘으면 그 자리에서 멈추고, 부르는 쪽이 「여기까지만 폈다」고 말해 준다.
 */
...
/**
 * 무엇이 몇 개인지 — 「이 안에 뭐가 들어 있나」의 한 줄 답.
...
/** 가장 깊은 곳이 몇 겹인가 — 「이거 얼마나 중첩됐나」를 먼저 묻는 사람이 많다. */
