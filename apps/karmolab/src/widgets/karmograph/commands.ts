 ...
 * 단축키도 또 따로였다. README 에 새 기능은 여기 한 줄이 늘어야 한다고 적어 뒀는데 . 
 * **사람 규율에 기댄 목록은 반드시 드리프트한다.** 실제로 판 이름 바꾸기가 두 자리에 살아 있었다.
 *
 * 그래서 무엇을 할 수 있나를 **한 곳**에 적는다. 서랍이 여기서 그려지고, 검사가 여기와
 ...
 * 파일 형식으로 묶으면 내가 뭘 골라야 하나를 사람이 번역해야 한다.
 *
