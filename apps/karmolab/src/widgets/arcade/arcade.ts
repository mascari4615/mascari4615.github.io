...
(function (): void {
  ...
  function injectStyles(): void {
    ...
    el.textContent = [
      ...
      '.ac-sol-cell.ac-held .ac-sol-card{box-shadow:0 0 0 2px #e0b95f,0 6px 14px rgba(0,0,0,.4);transform:translateX(6px)}',
      '.ac-sol-card{position:absolute;inset:0;display:block;border-radius:8px;background:var(--ac-card-face);box-shadow:var(--ac-card-sh);color:var(--ac-black);transition:transform var(--transition-fast)}',
