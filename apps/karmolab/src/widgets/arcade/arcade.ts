...
(function (): void {
  ...
  function injectStyles(): void {
    ...
    el.textContent = [
      ...
      '.ac-tlbar{width:200px;accent-color:var(--accent-ink)}',
      ...
      '.ac-seat.ac-me{border-color:var(--accent-ink);background:var(--accent-dim)}',
      ...
      '.ac-spc.ac-can{border-color:var(--accent-ink);cursor:pointer}',
      ...
      '.ac-spcard.ac-can{opacity:1;color:inherit;border-color:var(--accent-ink);cursor:pointer}',
      ...
      '.ac-slt.ac-can{cursor:pointer;border-color:var(--accent-ink);color:inherit}',
      ...
      '.ac-utsmall.ac-open{border-color:var(--accent-ink);box-shadow:0 0 0 1px var(--accent)}',
      ...
      '.ac-ycd.ac-keep{border-color:var(--accent-ink);background:color-mix(in srgb,var(--accent) 14%,var(--bg-primary))}',
      ...
      '.ac-yccat.ac-done{background:color-mix(in srgb,var(--accent) 10%,var(--bg-primary));border-color:var(--accent-ink);cursor:default}',
      ...
      '.ac-prc.ac-can{color:inherit;border-color:var(--accent-ink);cursor:pointer}',
      ...
      '.ac-bws.ac-me{border-color:var(--accent-ink)}',
      ...
      '.ac-dts.ac-me{border-color:var(--accent-ink)}',
      ...
      '.ac-liopt:hover{border-color:var(--accent-ink)}',
      ...
      '.ac-twq:hover,.ac-twg:hover{border-color:var(--accent-ink)}',
      ...
      '.ac-sgc.ac-last{border-color:var(--accent-ink)}',
      ...
      '.ac-mnp.ac-last{border-color:var(--accent-ink)}',
      ...
      '.ac-dbp:hover{border-color:var(--accent-ink)}',
      ...
      '.ac-rph.ac-pick{border-color:var(--accent-ink)}',
      ...
      '.ac-jglane.ac-me{border-color:var(--accent-ink);border-width:2px}',
      ...
      '.ac-yun.ac-big{width:30px;height:30px;margin:-15px 0 0 -15px;border-color:var(--accent-ink)}',
      ...
      '.ac-seat.ac-watch{border-color:var(--accent-ink);color:var(--accent-ink)}',
      ...
      '.ac-len.ac-short{color:var(--accent-ink);border-color:var(--accent-ink)}',
      ...
      '.ac-level button.ac-on{background:var(--accent);color:var(--accent-fg);border-color:var(--accent-ink);position:relative;z-index:1}',
