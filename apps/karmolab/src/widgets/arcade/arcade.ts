...
(function (): void {
  ...
  function injectStyles(): void {
    ...
    el.textContent = [
      ...
      '.ac-jglane{position:relative;flex:1 1 0;max-width:100%;height:min(46vh,240px);border:1px solid var(--border-color);border-radius:6px;background:var(--bg-secondary);overflow:hidden}',
