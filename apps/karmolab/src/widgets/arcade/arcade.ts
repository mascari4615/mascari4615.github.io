...
(function (): void {
  ...
  function injectStyles(): void {
    ...
    el.textContent = [
      ...
      '.ac-ycpaper.ac-pin{inset:0 auto 0 0;width:340px;padding:52px 12px 12px;background:linear-gradient(172deg,#f7efdc 0%,#efe4cb 70%,#e6d8ba 100%);box-shadow:8px 0 30px rgba(0,0,0,.45),inset -1px 0 0 rgba(120,80,40,.25);pointer-events:auto;display:block;opacity:1;overflow:auto}',
      '.ac-ycpaper.ac-pin .ac-ycpaperin{width:100%;max-height:none;padding:0;transform:none;background:none;box-shadow:none;font-size:var(--font-size-sm);opacity:1}',
      '.ac-ycpaper.ac-pin .ac-ycclose{display:none}',
      '.ac-ycpaper.ac-pin .ac-ychead{flex-wrap:wrap;margin-bottom:10px}',
      '.ac-ycpaper.ac-pin .ac-ychead .ac-ycdice .ac-die{width:30px;height:30px;padding:4px}',
      '.ac-ycpaper.ac-pin .ac-ychead .ac-ycleft{flex-basis:100%;margin-top:4px}',
      '.ac-ycpaper.ac-pin .ac-yctable th,.ac-ycpaper.ac-pin .ac-yctable td{padding:5px 6px;font-size:var(--font-size-sm)}',
      '.ac-ycpaper.ac-pin .ac-yctable td{font-size:var(--font-size-md)}',
      '.ac-ycpaper.ac-pin .ac-yccell{min-height:32px}',
      '#acPlay.ac-roomfill .ac-ycsplit .ac-t3.ac-t3bar{left:340px;width:auto;right:0}',
      '.ac-ycsplit .ac-ychud,.ac-ycsplit .ac-yctoast{left:calc(50% + 170px)}',
