...
(function (): void {
  ...
  function injectStyles(): void {
    ...
    el.textContent = [
      ...
      '.ac-root .ac-piece-pawn::after{content:"";position:absolute;left:9%;right:9%;bottom:0;height:60%;clip-path:polygon(30% 0,70% 0,100% 100%,0 100%);border-radius:4px;background:linear-gradient(90deg,var(--ac-piece-edge),var(--ac-piece-face) 28% 66%,color-mix(in srgb,var(--ac-piece-face) 65%,white));box-shadow:inset 0 -3px rgba(0,0,0,.18)}',
      ...
      '.ac-root .ac-piece-compact>span{font-size:8px}',
      ...
      '.ac-sgc{aspect-ratio:1;border:1px solid var(--ac-wood-line);border-radius:3px;background:var(--ac-wood);display:grid;place-items:center;padding:0;color:inherit;cursor:pointer}',
      ...
      '.ac-sgh{width:30px;height:34px;border:1px solid var(--border);border-radius:4px;background:var(--bg-primary);display:grid;place-items:center;color:inherit;padding:0;cursor:pointer}',
      ...
      '.ac-yun .ac-piece>span{font-size:7px}',
