...
export const ALL_CARDS: GameCard[] = [
  ...
  { id: 'auction', icon: '🔨', kind: 'card', seats: [2, 6], realtime: true, chunk: 'auction', hidden: true },
  ...
  { id: 'blackjack', icon: '♠️', kind: 'card', seats: [1, 4], realtime: false, chunk: 'blackjack', hidden: true },
  ...
  { id: 'derby', icon: '🐎', kind: 'card', seats: [1, 4], realtime: true, chunk: 'derby', hidden: true },
