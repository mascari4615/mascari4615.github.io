...
export const CARDS: GameCard[] = [
  ...
  { id: 'reversi', icon: '⚪', kind: 'board', seats: [2, 2], realtime: false, chunk: 'reversi', d3: true },
  ...
  { id: 'checkers', icon: '🔶', kind: 'board', seats: [2, 2], realtime: false, chunk: 'checkers', d3: true },
  ...
  { id: 'capturego', icon: '⚫', kind: 'board', seats: [2, 2], realtime: false, chunk: 'capturego', d3: true },
