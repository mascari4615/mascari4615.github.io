...
export const ALL_CARDS: GameCard[] = [
  ...
  { id: 'auction', icon: '🔨', kind: 'card', seats: [2, 6], realtime: true, chunk: 'auction', d3: true, hidden: true },
  ...
  { id: 'twenty', icon: '❓', kind: 'quick', seats: [1, 4], realtime: false, chunk: 'twenty', hidden: true },
  ...
  { id: 'hanafuda', icon: '🌸', kind: 'card', seats: [2, 4], realtime: false, chunk: 'hanafuda', d3: true, hidden: true },
  { id: 'derby', icon: '🐎', kind: 'card', seats: [1, 4], realtime: true, chunk: 'derby', d3: true, hidden: true },
  ...
  { id: 'memory', icon: '🃏', kind: 'puzzle', seats: [2, 4], realtime: true, chunk: 'memory', d3: true, hidden: true },
