 ...
 *
 * 지금까지 빈 자리는 봇 1, 봇 2였다. 그건 자리를 채운 것이지 **같이 논 것이 아니다.**
 * 사람은 상대가 누구인지 알면 판을 다르게 기억한다. 또 걔한테 졌다가 되려면 걔가 있어야 한다.
 *
 * 두 가지를 여기서 준다:
 *  - **이름**: 연구실 사람들. 한 방에서 같은 이름이 둘 나오지 않는다.
 *  - **손버릇**: 봇마다 손이 빠르거나 굼뜨다(0.7~1.4배). 이름과 함께 판 내내 유지된다 . 
 *    저 친구는 늘 먼저 지른다가 성립해야 성격이다.
 *
 ...
 *
 * 아주 짧은 뜸(50ms 아래)은 그대로 둔다. 그건 생각하는 척이 아니라 그 게임의 박자다.
 */
