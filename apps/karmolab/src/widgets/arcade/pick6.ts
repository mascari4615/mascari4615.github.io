/**
 * 추천 여섯 칸 — 51개 앞에서 「뭘 하지」를 대신 정한다 (TASK-KL-264 F4)
 *
 * 51개를 갈래별로 늘어놓은 로비는 목록이 아니라 **벽**이다. 고르기가 노는 것보다 힘들면
 * 사람은 창을 닫는다. 「오늘의 세 판」은 *모두에게 같은* 셋이고, 이 여섯은 *나에게 맞춘* 여섯이다.
 *
 ...
 *  ④ **길이를 섞는다** — 짧은 것이 최소 둘, 긴 것은 많아야 하나. 「지금 5분밖에 없다」가
 ...
 *
 * 「오목」을 치는 사람도 있고 「보드」를 치는 사람도 있고 「짧은」을 치는 사람도 있다.
