 ...
 * 늘 답을 줬으므로 안 온다가 없었는데, 이제는 **파일 하나가 빠지면 그 글꼴이 통째로 안 온다**.
...
for (const rel of ['index.html', 'scripts/gen-tool-pages.mjs']) {
  ...
  /* ★ **이 갈래는 죽어 있었다** (2026-08-17). 자기 머리말을 짜나를 `toolbox.css` 를 거는 줄로
  ...
  /* ★ 글자만 보면 주석, 본문에 적힌 이름도 부른다로 센다 (2026-08-17 룰: 구조를 봐라).
