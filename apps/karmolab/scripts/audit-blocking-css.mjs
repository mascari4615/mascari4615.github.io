...
if (process.argv.includes('--bless')) {
  fs.writeFileSync(BASELINE_TOTAL, JSON.stringify({ note: '도구 장이 첫 그림 전에 기다리는 스타일 바이트 — 늘면 빨강 (TASK-KL-323 이 줄인다)', 갱신: new Date().toISOString().slice(0, 10), list: totalBytes }, null, 2) + String.fromCharCode(10));
