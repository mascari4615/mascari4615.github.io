 ...
 *
 * 생성기의 고질병은 한 자리를 조용히 빠뜨리는 것이다. 그러면 사람은 「다 됐다」고 믿고
 * 넘어가는데, 실제로는 게이트가 며칠 뒤에 잡거나(운이 좋으면) **앱에서만 안 열린다**.
 * 그래서 여기서 잠그는 것은 「예쁘게 만드나」가 아니라 **「여덟 자리가 다 계획에 드나」**다.
 *
...
check(widget.includes('안 하는지'), '★ 머리말이 「무엇을 안 하는지」를 적으라고 시킨다 — 이 저장소의 규율');
...
/* ★ 자리표를 **잡는 게이트 이름**을 정확히 말해야 한다. 2026-08-20 에 여기가 틀려서
   「test:i18n 이 잡아 준다」고 적어 뒀는데 실제로는 100% 초록이었다(안 잡는다). */
