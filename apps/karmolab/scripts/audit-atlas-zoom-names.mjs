 ...
 *
 * ★ **한 번 죽었다 살아난 자다.** 덩어리 이름의 닻을 「보이는 글들의 무게중심」으로 고치자
 * 배율 8에서도 덩어리 이름이 따라오게 됐고, 그래서 **칸 이름을 통째로 지워도 빈 자리가
 * 0곳**이 됐다 — 물기 harness 가 「칸 이름을 지운다」를 못 잡는 걸로 들켰다. 「빈 자리가
 * 없다」만 보면 **칸 이름이 있으나 없으나 초록**이다. 그래서 이제 **칸 이름 자체가 살아
...
/* ★ **칸 이름 자체가 살아 있나** — 「빈 자리 0」은 덩어리 이름만으로도 나므로 그것만
