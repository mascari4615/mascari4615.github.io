...
await 될때까지(page,()=>document.querySelectorAll('.hu-lane[data-kind=midi] .hu-clip.is-selected').length>0,{최대:3000});
...
await 될때까지(page,()=>document.querySelectorAll('.hu-clip.is-muted').length>0,{최대:3000});
