 ...
 *
 * `audit:generated` 는 낡은 파생물을 보고 「막지 않는다 — 새벽 `refresh-generated` 가 굽는다」고
 ...
 * 「밤에 굽는다」고 말할 거면, 그 밤이 **최근에 실제로 초록이었어야** 한다.
 *
 * 판정:
 *   0  마지막 판이 초록이고 사흘 안쪽 — 약속이 살아 있다
 *   1  마지막 판이 빨강이거나 너무 오래됨 — 파생물이 조용히 늙고 있다
 *   2  못 물어봤다 (gh 없음·인증 없음·네트워크) — 「아니오」가 아니다
 *
...
if (!Array.isArray(runs) || runs.length === 0) {
  console.error(`[nightly-alive] ${WF} 이 **한 판도 안 돌았다** — 「밤에 굽는다」는 약속이 빈말이다`);
  process.exit(1);
}
