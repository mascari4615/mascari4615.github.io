...
const OVER_LIMIT_DEBT = {
  ...
  /* 오락실은 놀이를 계속 더하는 중이라 천장을 넘겼다(65.3KB, 2026-08-12). 놀이별로 늦게
     ...
     ★ 2026-09-04: 줄이 지워져 있었고 그 사이 80.1KB 까지 컸다 (65.3 에서 +14.8KB, 놀이 여럿).
     앞 단계가 빨개서 이 검사가 오래 못 돌았고, 초록이 되자마자 전원이 멈췄다. 다시 적는다. */
  'arcade/arcade.js': '놀이별로 늦게 받게 쪼갤 것. 2026-09-04 80.1KB (한계 64KB)',
};
