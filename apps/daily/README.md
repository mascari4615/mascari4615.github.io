...
- 표마다  이 박힌다. **180일 넘으면 빌드가 선다** (150일부터 경고).
- OK genshin   우리  116 · 원본  116 · 만든 날 2026-08-07 (여행자 계열 제외)
OK lol       우리  173 · 원본  173 · 만든 날 2026-08-07 (16.15.1)
OK pokemon   우리 1025 · 원본 1025 · 만든 날 2026-08-07 (전 세대) — 원본에 물어 실제 항목 수를 대조한다. 배포에선 안 돈다
  (바깥 서버가 잠깐 말썽인 것으로 배포를 세울 이유가 없다).
- 세는 규칙은 표 만들 때와 **같은 파일**을 쓴다 (). 따로 적었더니
